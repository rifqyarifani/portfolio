...
export default function projects() {
  return (
    <div className='px-6 sm:px-36 py-32 text-center sm:text-left' id='projects'>
        ...
        <div className=' flex flex-col items-center sm:flex-row sm:justify-around gap-5 sm:gap-10 bg-slate-50 p-4 rounded-2xl shadow-slate-400 shadow-sm mb-20'>
            ...
            <div className=' flex flex-col items-center gap-4 z-10'>
                ...
                <p className=' text-center max-w-md'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut vero molestias earum animi neque autem repellendus maxime veritatis, ratione praesentium.</p>
        ...
        <div className=' flex flex-col items-center sm:flex-row-reverse sm:justify-around gap-5 sm:gap-10 bg-slate-50 p-4 rounded-2xl shadow-slate-400 shadow-sm'>
